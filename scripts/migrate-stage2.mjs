...
try {
  for (const migration of ['apps/adx-api/db/001_tenant_rls.sql', 'apps/adx-api/db/002_change_case_ledger.sql', 'apps/adx-api/db/003_intake_governance.sql', 'apps/adx-api/db/004_design_governance.sql', 'apps/adx-api/db/005_execution_governance.sql', 'apps/adx-api/db/006_verification_evidence.sql']) await pool.query(await readFile(migration, 'utf8'))
  console.log('ADX database migrations through Stage 6 applied.')
