...
export function authorizationAction(method, operation) {
  if (operation === 'story-milestones') return 'resource.write'
  if (method === 'GET') return 'resource.read'
  return ['design-decision', 'verification-decision', 'delivery-decision', 'outcome-record', 'outcome-completion'].includes(operation) ? 'resource.review' : 'resource.write'
}
