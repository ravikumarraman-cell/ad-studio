...
test('story review renders the focused decision surface and retained story evidence', () => {
  ...
  assert.match(page, /id="story-decision-approve"/)
  assert.match(page, /for="story-decision-approve"/)
  assert.match(page, /id="story-decision-return"/)
  assert.match(page, /for="story-decision-return"/)
