...
export function outcomeReviewPage(changeCase, records, options = {}) {
  ...
  const next =
    isReadyForDelivery
      ? 'Complete Gate F by selecting a retained outcome record and recording it against this Change Case.'
      : isOutcomeRecorded
  ...
  const completionPanel = isReadyForDelivery
    ? records.length
      ...
      : `<section class="action-panel blocked"><p class="panel-label">GATE F · OUTCOME COMPLETION</p><h2>No retained outcome records are available</h2><p>Gate F cannot be completed until an outcome is retained in the outcome ledger. This screen stays read-only until that upstream evidence exists.</p></section>`
    : isOutcomeRecorded
