...
export function uiRedirectLocation(value) {
  try {
    const url = new URL(value || "http://localhost:5174/");
...
export const accessiblePageFoundation = `${adxPageThemeCss}<style id="adx-accessibility-foundation">p,.muted{color:var(--adx-copy)}.eyebrow{font-size:.75rem;letter-spacing:.12em;font-weight:700;color:var(--adx-muted)}input,select,textarea{color:var(--adx-ink);background:var(--adx-surface);border-color:var(--adx-line)}input[type="checkbox"],input[type="radio"]{width:auto!important;min-width:0!important;padding:0!important;flex:0 0 auto!important}input::placeholder,textarea::placeholder{color:var(--adx-muted);opacity:1}.error{color:var(--adx-danger)}.workspace-return-link{position:fixed;top:12px;left:16px;z-index:10;display:inline-block;padding:6px 10px;border:1px solid var(--adx-line);border-radius:8px;background:var(--adx-surface);box-shadow:0 1px 4px #14213d14;color:var(--adx-brand-deep);font-size:.78rem;font-weight:700;text-decoration:none}.workspace-return-link:hover{background:var(--adx-surface-soft)}.signed-in-indicator{position:fixed;top:12px;right:16px;z-index:10;display:flex;gap:6px;align-items:baseline;max-width:calc(100vw - 32px);padding:6px 10px;background:var(--adx-surface);border:1px solid var(--adx-line);border-radius:8px;box-shadow:0 1px 4px #14213d14;color:var(--adx-copy);font-size:.78rem}.signed-in-indicator strong{overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--adx-ink);font-weight:700}@media (max-width:600px){.workspace-return-link,.signed-in-indicator{position:static;width:max-content;max-width:calc(100% - 32px);margin:10px 16px 0}.signed-in-indicator strong{max-width:14rem}}</style>`;
