...
| 4 — Design and security gates | `IN_PROGRESS` | Tenant-scoped, versioned design package; digest-bound independent approval; exception expiry; R2+ direct-transition gate; design-review workbench; and local API/browser evidence. | Hosted-CI evidence before completion. |
