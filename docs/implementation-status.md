...
| 4 — Design and security gates | `IN_PROGRESS` | Tenant-scoped, versioned design package; digest-bound independent approval; exception expiry; R2+ direct-transition gate; design-review workbench; local API/browser evidence; and matching hosted-CI checks. | A successful hosted run containing the Stage 4 checks. |
