...
**Exit approved.** All Stage 0 requirements have reproducible local evidence, and the hosted GitHub Actions `Stage 0 gate` completed successfully on `main`. Stage 1 may begin.
